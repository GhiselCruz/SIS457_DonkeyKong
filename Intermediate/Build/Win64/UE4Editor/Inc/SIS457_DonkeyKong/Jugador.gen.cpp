...
#include "SIS457_DonkeyKong/Jugador.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	SIS457_DONKEYKONG_API UClass* Z_Construct_UClass_AJugador_NoRegister();
	SIS457_DONKEYKONG_API UClass* Z_Construct_UClass_AJugador();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AJugador_Statics::Class_MetaDataParams[] = {
		...
		const UE4CodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_AJugador_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UDecoradorInterface_NoRegister, (int32)VTABLE_OFFSET(AJugador, IDecoradorInterface), false },
		};
	...
	IMPLEMENT_CLASS(AJugador, 975410120);
	template<> SIS457_DONKEYKONG_API UClass* StaticClass<AJugador>()
	{
		return AJugador::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AJugador(Z_Construct_UClass_AJugador, &AJugador::StaticClass, TEXT("/Script/SIS457_DonkeyKong"), TEXT("AJugador"), false, nullptr, nullptr, nullptr);
